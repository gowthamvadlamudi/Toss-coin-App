...
class CoinToss extends Component {
  ...
  render() {
    const {isHead, theTotal, totalHead, totalTails} = this.state
    const image = isHead
      ...
      <div className="app-container">
        <div className="coin-toss-container">
          ...
          <div className="image-container">
            <img src={image} alt="toss result" className="heads-tails-image" />
          </div>
          ...
          <div className="scores-container">
            <div className="total-score-container">
              <p className="score-status">Total:{theTotal} </p>
            </div>
            <div className="total-score-container">
              <p className="score-status">Heads:{totalHead} </p>
            </div>
            <div className="total-score-container">
